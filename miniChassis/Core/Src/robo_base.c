...
void BASE_Init(ROBO_BASE *Robo)       
{
  ...
  P_Speed=&Robo->Speed_MotorLF; PID_Init(&P_Speed->Speed_PID,	15.0f,	0.1f,	0,	3000,	0,	3000,	5000); P_Speed->Motor_Num=0;
  P_Speed=&Robo->Speed_MotorLB; PID_Init(&P_Speed->Speed_PID,	15.0f,	0.1f,	0,	3000,	0,	3000,	5000); P_Speed->Motor_Num=1;
  P_Speed=&Robo->Speed_MotorRF; PID_Init(&P_Speed->Speed_PID,	15.0f,	0.1f,	0,	3000,	0,	3000,	5000); P_Speed->Motor_Num=2;
}
