...
//extern chassis_speed* chassis_targe;
//--------------------------------//
...
//  P_Speed=&Robo->Speed_MotorLB; PID_Init(&P_Speed->Speed_PID,	3.0f,	0.1f,	0,	2000,	0,	1000,	1000); P_Pos->Motor_Num=3;
}
...
//  Send_To_Motor_(&hcan2,Robo->Tx_CAN2);
